...
| Sega `.rel` data (PSO levels, SADX models), Billy Hatcher `.prd` | PSO, SADX, Billy Hatcher | footer / pointer table known | [formats/sonic-team-gamecube.md](formats/sonic-team-gamecube.md) |
