...
names), WWE Day of Reckoning (`main.dol`, no symbols - the strip loop writing to the write-gather pipe at `0x800bdb2c` settled the version-4 YOBJ corner), and the DOLs of Madden 06, Tiger Woods 2005, Frogger and Billy & Mandy (no symbols -
