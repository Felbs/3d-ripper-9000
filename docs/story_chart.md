...
**25 of 28 steps are reachable in the remake** (3 partial, 0 missing).
...
flowchart TD
    ...
    grandma_after_sword["grandma_after_sword<br/>sets 0x0602<br/><i>talk - PARTIAL</i>"]
    ...
    tetra_board_ship["tetra_board_ship<br/><i>talk - PARTIAL</i>"]
...
| grandma_after_sword | talk | Ba1 |  |  |  | 0x0602 | **partial** | gated on non-bit state: collect[0] bit0 |
...
| tetra_board_ship | talk | Zl1 |  |  | 0x0E20 |  | **partial** | gated on non-bit state: collect[1] bit0 |
