...
| Acclaim `supertree0.tre` models (Vexx, Turok: Evolution) | 2 | **container and textures ship (2026-09-04)**: a hash-sorted table tiles the whole file; textures decode.  Open: where the models are - no GX lists in the big members; the `atr` actor definitions reference them by path | [formats/acclaim-supertree.md](formats/acclaim-supertree.md) |
