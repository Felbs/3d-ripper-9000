...
| Free Radical `gcr` meshes | 3 (TimeSplitters 2, Future Perfect, Second Sight) | the container ships and 99% of the `gct` textures decode, so the geometry is what is left: 2,467 `gcr` in a 149-archive sample, untouched.  Three `gct` codes (9, 11, 12) are also unidentified, together under 3% of the textures | see [formats/free-radical-pck.md](formats/free-radical-pck.md) |
